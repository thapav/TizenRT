 ...
 *
 */
__STATIC_INLINE void hw_bod_activate_channel(bod_channel_t channel) __attribute__((always_inline));

__STATIC_INLINE void hw_bod_activate_channel(bod_channel_t channel)
{
 ...
 *
 */
__STATIC_INLINE void hw_bod_deactivate_channel(bod_channel_t channel) __attribute__((always_inline));

__STATIC_INLINE void hw_bod_deactivate_channel(bod_channel_t channel)
{
 ...
 *
 */
__STATIC_INLINE void hw_bod_deactivate(void) __attribute__((always_inline));

__STATIC_INLINE void hw_bod_deactivate(void)
{
