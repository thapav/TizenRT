 ...
 *
 */
__STATIC_INLINE void hw_gpio_pad_latch_disable_all(void) __attribute__((always_inline));

__STATIC_INLINE void hw_gpio_pad_latch_disable_all(void)
{
        GLOBAL_INT_DISABLE();
 ...
 *
 */
__STATIC_INLINE void hw_gpio_pad_latch_enable_all(void) __attribute__((always_inline));

__STATIC_INLINE void hw_gpio_pad_latch_enable_all(void)
{
        GLOBAL_INT_DISABLE();
 ...
 */
__STATIC_INLINE void hw_gpio_pad_latch_enable(HW_GPIO_PORT port, HW_GPIO_PIN pin) __attribute__((always_inline));

__STATIC_INLINE void hw_gpio_pad_latch_enable(HW_GPIO_PORT port, HW_GPIO_PIN pin)
{
 ...
 */
__STATIC_INLINE void hw_gpio_pad_latch_disable(HW_GPIO_PORT port, HW_GPIO_PIN pin) __attribute__((always_inline));

__STATIC_INLINE void hw_gpio_pad_latch_disable(HW_GPIO_PORT port, HW_GPIO_PIN pin)
{
        ASSERT_WARNING((port == HW_GPIO_PORT_0) || (port == HW_GPIO_PORT_1));
 ...
 */
__STATIC_INLINE bool hw_gpio_pad_latch_is_enabled(HW_GPIO_PORT port, HW_GPIO_PIN pin) __attribute__((always_inline));

__STATIC_INLINE bool hw_gpio_pad_latch_is_enabled(HW_GPIO_PORT port, HW_GPIO_PIN pin)
{
        ASSERT_WARNING((port == HW_GPIO_PORT_0) || (port == HW_GPIO_PORT_1));
