 ...
 */
__STATIC_INLINE volatile void *hw_ecc_get_location_address(unsigned int location, volatile void *base_addr)
{
 ...
 */
__STATIC_INLINE volatile void *hw_ecc_get_configured_location_address(unsigned int location)
{
 ...
 */
__STATIC_INLINE void hw_ecc_load_ucode(const uint32_t *ucode, unsigned int ucode_size)
{
 ...
 */
__STATIC_INLINE void hw_ecc_enable_clock(void)
{
        GLOBAL_INT_DISABLE();
 ...
 */
__STATIC_INLINE void hw_ecc_disable_clock(void)
{
        GLOBAL_INT_DISABLE();
 ...
 */
__STATIC_INLINE int hw_ecc_clock_is_enabled(void)
{
 ...
 */
__STATIC_INLINE void hw_ecc_cfg_ops(unsigned int a, unsigned int b, unsigned int c)
{
        /* Only 16 256-bit locations are available in the Data RAM used by ECC */
        ASSERT_ERROR(a <= 0xF);
        ASSERT_ERROR(b <= 0xF);
 ...
 */
__STATIC_INLINE void hw_ecc_write_command_register(HW_ECC_CMD_CALCR2 calcr2,
 ...
 * \sa hw_ecc_write_command_register()
 */
__STATIC_INLINE void hw_ecc_write_command_register_raw(uint32_t value)
{
 ...
 */
__STATIC_INLINE void hw_ecc_start(void)
{
 ...
 */
__STATIC_INLINE unsigned int hw_ecc_read_status(void)
{
 ...
 */
__STATIC_INLINE void hw_ecc_clear_interrupt_source(void)
{
        volatile uint32_t dummy __UNUSED;
