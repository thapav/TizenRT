 ...
 *
 */
__STATIC_INLINE void hw_timer1_freeze(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer1_unfreeze(void)
{
 ...
 *
 */
__STATIC_INLINE bool hw_timer1_frozen(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer1_set_clk(HW_TIMER1_CLK_SRC clk)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer1_set_prescaler(uint16_t value)
{
 ...
 */
__STATIC_INLINE void hw_timer1_set_reload(uint32_t value)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer1_set_oneshot_delay(uint32_t delay)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer1_set_shot_width(uint32_t duration)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer1_set_freerun(bool enabled)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer1_set_event1_trigger(HW_TIMER1_TRIGGER edge)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer1_set_event2_trigger(HW_TIMER1_TRIGGER edge)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer1_set_event1_gpio(HW_TIMER1_GPIO gpio)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer1_set_event2_gpio(HW_TIMER1_GPIO gpio)
{
 ...
 *
 */
__STATIC_INLINE HW_TIMER1_CLK_SRC hw_timer1_get_clk(void)
{
 ...
 *
 */
__STATIC_INLINE uint16_t hw_timer1_get_prescaler(void)
{
 ...
 *
 */
__STATIC_INLINE uint32_t hw_timer1_get_reload(void)
{
 ...
 *
 */
__STATIC_INLINE uint32_t hw_timer1_get_oneshot_delay(void)
{
        return TIMER1->CAPTIM_RELOAD_REG;
}
 ...
 *
 */
__STATIC_INLINE uint32_t hw_timer1_get_shot_width(void)
{
 ...
 *
 */
__STATIC_INLINE bool hw_timer1_get_freerun(void)
{
 ...
 *
 */
__STATIC_INLINE HW_TIMER1_TRIGGER hw_timer1_get_event1_trigger(void)
{
 ...
 *
 */
__STATIC_INLINE HW_TIMER1_TRIGGER hw_timer1_get_event2_trigger(void)
{
 ...
 *
 */
__STATIC_INLINE HW_TIMER1_GPIO hw_timer1_get_event1_gpio(void)
{
 ...
 *
 */
__STATIC_INLINE HW_TIMER1_GPIO hw_timer1_get_event2_gpio(void)
{
 ...
 *
 */
__STATIC_INLINE uint32_t hw_timer1_get_capture1(void)
{
 ...
 *
 */
__STATIC_INLINE uint32_t hw_timer1_get_capture2(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer1_set_direction(HW_TIMER1_DIR dir)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer1_set_mode(HW_TIMER1_MODE mode)
{
 ...
 *
 */
__STATIC_INLINE HW_TIMER1_MODE hw_timer1_get_mode(void)
{
 ...
 *
 */
__STATIC_INLINE uint32_t hw_timer1_get_count(void)
{
#if (dg_configBLACK_ORCA_IC_REV != BLACK_ORCA_IC_REV_A) && (dg_configUSE_AUTO_CHIP_DETECTION != 1)
        uint32_t lo, hi;
        GLOBAL_INT_DISABLE();
 ...
 *
 */
__STATIC_INLINE HW_TIMER1_ONESHOT hw_timer1_get_oneshot_phase(void)
{
 ...
 *
 */
__STATIC_INLINE bool hw_timer1_get_gpio1_state(void)
{
 ...
 *
 */
__STATIC_INLINE bool hw_timer1_get_gpio2_state(void)
{
 ...
 *
 */
__STATIC_INLINE uint16_t hw_timer1_get_prescaler_val(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer1_int_enable(void) __attribute__((always_inline));

__STATIC_INLINE void hw_timer1_int_enable(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer1_int_disable(void) __attribute__((always_inline));

__STATIC_INLINE void hw_timer1_int_disable(void)
{
 ...
 *
 */
__STATIC_INLINE uint32_t hw_timer1_get_value(void) __attribute__((always_inline));

__STATIC_INLINE uint32_t hw_timer1_get_value(void)
{
#if dg_configBLACK_ORCA_IC_REV == BLACK_ORCA_IC_REV_A
        return TIMER1->CAPTIM_TIMER_VAL_REG;
#else
 ...
 *
 */
__STATIC_INLINE uint32_t hw_timer1_get_trigger(void)
{
#if dg_configBLACK_ORCA_IC_REV == BLACK_ORCA_IC_REV_A
        return TIMER1->CAPTIM_RELOAD_REG;
#else
 ...
 *
 */
__STATIC_INLINE void hw_timer1_invalidate_trigger(void)  __attribute__((always_inline));

__STATIC_INLINE void hw_timer1_invalidate_trigger(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer1_enable(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer1_disable(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer1_set_pwm_freq(uint16_t value)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer1_set_pwm_duty_cycle(uint16_t value)
{
 ...
 *
 */
__STATIC_INLINE uint16_t hw_timer1_get_pwm_freq(void)
{
 ...
 *
 */
__STATIC_INLINE uint16_t hw_timer1_get_pwm_duty_cycle(void)
{
