 ...
 */
__STATIC_INLINE void hw_pmu_1v8f_enable(void) __attribute__((always_inline));

__STATIC_INLINE void hw_pmu_1v8f_enable(void)
{
 ...
 *                 error code otherwise.
 */
__STATIC_INLINE HW_PMU_ERROR_CODE hw_pmu_1v8f_disable(void) __attribute__((always_inline));

__STATIC_INLINE HW_PMU_ERROR_CODE hw_pmu_1v8f_disable(void)
{
 ...
 *  - HW_PMU_ERROR_RC32K_ON: RC32K is enabled
