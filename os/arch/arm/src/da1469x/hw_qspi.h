...
#define HW_QSPI_MAX_ADDR_SIZE 0x2000000
...
struct qspic_instructions {
        ...
        struct {
                ...
                uint8_t cs_hi_cycles;           /*!< The minimum number of QSPI bus clock cycles (0..31) that QSPI_CS remains
                                                high after the execution of write enable, erase, erase suspend and erase
                                                resume instructions. */
        } erase_instruction;
 ...
 *
 */
__STATIC_INLINE void hw_qspi_cs_enable(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_cs_enable(HW_QSPIC_ID id)
{
 ...
 *
 */
__STATIC_INLINE void hw_qspi_cs_disable(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_cs_disable(HW_QSPIC_ID id)
{
 ...
 *
 */
__STATIC_INLINE bool hw_qspi_is_busy(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE bool hw_qspi_is_busy(HW_QSPIC_ID id)
{
 ...
 *
 */
__STATIC_INLINE uint32_t hw_qspi_read32(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE uint32_t hw_qspi_read32(HW_QSPIC_ID id)
{
 ...
 *
 */
__STATIC_INLINE uint16_t hw_qspi_read16(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE uint16_t hw_qspi_read16(HW_QSPIC_ID id)
{
 ...
 *
 */
__STATIC_INLINE uint8_t hw_qspi_read8(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE uint8_t hw_qspi_read8(HW_QSPIC_ID id)
{
 ...
 *
 */
__STATIC_INLINE void hw_qspi_write32(HW_QSPIC_ID id, uint32_t data) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_write32(HW_QSPIC_ID id, uint32_t data)
{
 ...
 *
 */
__STATIC_INLINE void hw_qspi_write16(HW_QSPIC_ID id, uint16_t data) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_write16(HW_QSPIC_ID id, uint16_t data)
{
 ...
 *
 */
__STATIC_INLINE void hw_qspi_write8(HW_QSPIC_ID id, uint8_t data) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_write8(HW_QSPIC_ID id, uint8_t data)
{
 ...
 *
 */
__STATIC_INLINE void hw_qspi_dummy32(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_dummy32(HW_QSPIC_ID id)
{
 ...
 *
 */
__STATIC_INLINE void hw_qspi_dummy16(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_dummy16(HW_QSPIC_ID id)
{
 ...
 *
 */
__STATIC_INLINE void hw_qspi_dummy8(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_dummy8(HW_QSPIC_ID id)
{
 ...
 *
 */
__STATIC_INLINE void hw_qspi_set_address_size(HW_QSPIC_ID id, HW_QSPI_ADDR_SIZE size) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_set_address_size(HW_QSPIC_ID id, HW_QSPI_ADDR_SIZE size)
{
 ...
 *
 */
__STATIC_INLINE HW_QSPI_ADDR_SIZE hw_qspi_get_address_size(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE HW_QSPI_ADDR_SIZE hw_qspi_get_address_size(HW_QSPIC_ID id)
{
 ...
 *
 */
__STATIC_INLINE uint8_t hw_qspi_get_read_pipe_clock_delay(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE uint8_t hw_qspi_get_read_pipe_clock_delay(HW_QSPIC_ID id)
{
 ...
 *
 */
__STATIC_INLINE void hw_qspi_set_read_pipe_clock_delay(HW_QSPIC_ID id, uint8_t delay) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_set_read_pipe_clock_delay(HW_QSPIC_ID id, uint8_t delay)
{
        ASSERT_WARNING(delay < 8);
        // Delay cannot be greater than 2 when VDD_CORE is not 1.2V
        ASSERT_WARNING(REG_GETF(CRG_TOP, POWER_CTRL_REG, VDD_LEVEL) == 0x3 || delay <= 2);
 ...
 *
 */
__STATIC_INLINE bool hw_qspi_is_read_pipe_enabled(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE bool hw_qspi_is_read_pipe_enabled(HW_QSPIC_ID id)
{
 ...
 *
 */
__STATIC_INLINE void hw_qspi_read_pipe_enable(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_read_pipe_enable(HW_QSPIC_ID id)
{
 ...
 *
 */
__STATIC_INLINE void hw_qspi_read_pipe_disable(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_read_pipe_disable(HW_QSPIC_ID id)
{
 ...
 *
 */
__STATIC_INLINE HW_QSPI_SAMPLING_EDGE hw_qspi_get_read_sampling_edge(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE HW_QSPI_SAMPLING_EDGE hw_qspi_get_read_sampling_edge(HW_QSPIC_ID id)
{
 ...
 *
 */
__STATIC_INLINE void hw_qspi_set_read_sampling_edge(HW_QSPIC_ID id, HW_QSPI_SAMPLING_EDGE edge) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_set_read_sampling_edge(HW_QSPIC_ID id, HW_QSPI_SAMPLING_EDGE edge)
{
 ...
 *
 */
__STATIC_INLINE HW_QSPI_HREADY_MODE hw_qspi_get_hready_mode(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE HW_QSPI_HREADY_MODE hw_qspi_get_hready_mode(HW_QSPIC_ID id)
{
 ...
 *
 */
__STATIC_INLINE void hw_qspi_set_hready_mode(HW_QSPIC_ID id, HW_QSPI_HREADY_MODE mode) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_set_hready_mode(HW_QSPIC_ID id, HW_QSPI_HREADY_MODE mode)
{
 ...
 *
 */
__STATIC_INLINE HW_QSPI_POL hw_qspi_get_clock_mode(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE HW_QSPI_POL hw_qspi_get_clock_mode(HW_QSPIC_ID id)
{
 ...
 *
 */
__STATIC_INLINE void hw_qspi_set_clock_mode(HW_QSPIC_ID id, HW_QSPI_POL mode) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_set_clock_mode(HW_QSPIC_ID id, HW_QSPI_POL mode)
{
 ...
 *
 */
__STATIC_INLINE void hw_qspi_set_pad_direction(
        HW_QSPIC_ID id, HW_QSPI_PAD pad, HW_QSPI_DIRECTION direction) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_set_pad_direction(
        HW_QSPIC_ID id, HW_QSPI_PAD pad, HW_QSPI_DIRECTION direction)
{
        if (pad == HW_QSPI_IO2) {
 ...
 *
 */
__STATIC_INLINE void hw_qspi_set_pad_value(HW_QSPIC_ID id, HW_QSPI_PAD pad, bool dat) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_set_pad_value(HW_QSPIC_ID id, HW_QSPI_PAD pad, bool dat)
{
        if (pad == HW_QSPI_IO2) {
 ...
 *
 */
__STATIC_INLINE bool hw_qspi_get_pad_value(HW_QSPIC_ID id, HW_QSPI_PAD pad) __attribute__((always_inline));

__STATIC_INLINE bool hw_qspi_get_pad_value(HW_QSPIC_ID id, HW_QSPI_PAD pad)
{
        if (pad == HW_QSPI_IO2) {
 ...
 *
 */
__STATIC_INLINE HW_QSPI_ACCESS_MODE hw_qspi_get_access_mode(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE HW_QSPI_ACCESS_MODE hw_qspi_get_access_mode(HW_QSPIC_ID id)
{
 ...
 *
 */
__STATIC_INLINE void hw_qspi_set_dummy_bytes_count(HW_QSPIC_ID id, uint8_t count) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_set_dummy_bytes_count(HW_QSPIC_ID id, uint8_t count)
{
 ...
 *
 */
__STATIC_INLINE void hw_qspi_set_extra_byte(
        HW_QSPIC_ID id, uint8_t extra_byte, bool send_extra_byte, HW_QSPI_BUS_MODE bus_mode,
        bool half_disable_out) __attribute__((always_inline));
        ...
        bool half_disable_out)
{
        ...
        id->QSPIC_BURSTCMDB_REG = (id->QSPIC_BURSTCMDB_REG &
                                  ...
                                  BITS32(QSPIC, QSPIC_BURSTCMDB_REG, QSPIC_EXT_BYTE_EN, send_extra_byte) |
                                  BITS32(QSPIC, QSPIC_BURSTCMDB_REG, QSPIC_EXT_HF_DS, half_disable_out);
}

/**
 * \brief Set the number of clocks that CS stays high
 *
 * \param [in] id QSPI controller id
 * \param [in] clock_count between the transmission of two different instructions to the
 *                         memory, the QSPI bus stays in idle state (QSPI_CS high)
 *                         for at least this number of SPI clock cycles (0..7). See QSPIC_ERS_CS_HI
 *                         in QSPIC_ERASECMDB_REG/QSPIC2_ERASECMDB_REG for an exception
 *
 */
__STATIC_INLINE void hw_qspi_set_min_cs_high(HW_QSPIC_ID id, uint8_t clock_count) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_set_min_cs_high(HW_QSPIC_ID id, uint8_t clock_count)
{
        ASSERT_WARNING(clock_count < 8);
        HW_QSPIC_REG_SETF(id, BURSTCMDB, CS_HIGH_MIN, clock_count);
}
 ...
 *
 */
__STATIC_INLINE HW_QSPI_ERS hw_qspi_get_erase_status(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE HW_QSPI_ERS hw_qspi_get_erase_status(HW_QSPIC_ID id)
{
 ...
 *
 */
__STATIC_INLINE void hw_qspi_burst_break_sequence_enable(
        HW_QSPIC_ID id, uint16_t sequence, HW_QSPI_BUS_MODE mode,
        HW_QSPI_BREAK_SEQ_SIZE size, bool dis_out) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_burst_break_sequence_enable(
        HW_QSPIC_ID id, uint16_t sequence, HW_QSPI_BUS_MODE mode,
        HW_QSPI_BREAK_SEQ_SIZE size, bool dis_out)
{
 ...
 *
 */
__STATIC_INLINE void hw_qspi_burst_break_sequence_disable(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_burst_break_sequence_disable(HW_QSPIC_ID id)
{
 ...
 *
 */
__STATIC_INLINE void hw_qspi_set_pads(
        HW_QSPIC_ID id, HW_QSPI_SLEW_RATE rate, HW_QSPI_DRIVE_CURRENT current) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_set_pads(
        HW_QSPIC_ID id, HW_QSPI_SLEW_RATE rate, HW_QSPI_DRIVE_CURRENT current)
{
        id->QSPIC_GP_REG =
 ...
 *
 */
__STATIC_INLINE void hw_qspi_clock_enable(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_clock_enable(HW_QSPIC_ID id)
{
        GLOBAL_INT_DISABLE();
        if (id == HW_QSPIC) {
                ...
                REG_SET_BIT(CRG_TOP, CLK_AMBA_REG, QSPI2_ENABLE);
#endif
        } else {
                ASSERT_WARNING(0);
        }
 ...
 *
 */
__STATIC_INLINE void hw_qspi_clock_disable(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_clock_disable(HW_QSPIC_ID id)
{
        GLOBAL_INT_DISABLE();
        if (id == HW_QSPIC) {
                ...
                REG_CLR_BIT(CRG_TOP, CLK_AMBA_REG, QSPI2_ENABLE);
#endif
        } else {
                ASSERT_WARNING(0);
        }
 ...
 * \sa HW_QSPI_DIV
 */
__STATIC_INLINE void hw_qspi_set_div(HW_QSPIC_ID id, HW_QSPI_DIV div) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_set_div(HW_QSPIC_ID id, HW_QSPI_DIV div)
{
        GLOBAL_INT_DISABLE();

        uint32_t reg = CRG_TOP->CLK_AMBA_REG;
        if (id == HW_QSPIC) {
                // Disable QSPI clock before changing the divider
                REG_CLR_BIT(CRG_TOP, CLK_AMBA_REG, QSPI_ENABLE);

                // Set the divider
                REG_SET_FIELD(CRG_TOP, CLK_AMBA_REG, QSPI_DIV, reg, div);
#if dg_configUSE_HW_QSPI2
        } else if (id == HW_QSPIC2) {
                // Disable QSPI2 clock before changing the divider
                REG_CLR_BIT(CRG_TOP, CLK_AMBA_REG, QSPI2_ENABLE);

                // Set the divider
                REG_SET_FIELD(CRG_TOP, CLK_AMBA_REG, QSPI2_DIV, reg, div);
#endif
        } else {
                ASSERT_WARNING(0);
        }
 ...
 * \sa HW_QSPI_DIV
 */
__STATIC_INLINE HW_QSPI_DIV hw_qspi_get_div(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE HW_QSPI_DIV hw_qspi_get_div(HW_QSPIC_ID id)
{
        if (id == HW_QSPIC) {
 ...
 *
 */
__STATIC_INLINE void hw_qspi_enable_init(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_enable_init(HW_QSPIC_ID id)
{
        if (id == HW_QSPIC) {
                GLOBAL_INT_DISABLE();
 ...
 *
 */
__STATIC_INLINE void hw_qspi_disable_init(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_disable_init(HW_QSPIC_ID id)
{
        if (id == HW_QSPIC) {
                GLOBAL_INT_DISABLE();
                REG_CLR_BIT(CRG_TOP, SYS_CTRL_REG, QSPI_INIT);
                GLOBAL_INT_RESTORE();
        } else {
                ASSERT_WARNING(0);
        }
 ...
 */
__STATIC_INLINE bool hw_qspi_is_init_enabled(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE bool hw_qspi_is_init_enabled(HW_QSPIC_ID id)
{
        ASSERT_WARNING(id == HW_QSPIC);
        return REG_GETF(CRG_TOP, SYS_CTRL_REG, QSPI_INIT) == 1;
}


/**
 * \brief Defines the behavior of the controller when the internal buffer is full
 *        and there are more data to be retrieved for the current burst.
 *        It has meaning only for reads in auto mode.
 *
 * \param [in] id QSPI controller id
 * \param [in] enable
 *        false - The access to the flash device is not terminated when the internal
 *                buffer has no empty space. In this case the QSPI_SCK clock is blocked
 *                until space is freed in the internal buffer.
 *        true  - The access to the flash device is terminated when the internal buffer
 *                has no empty space. A new access to the flash device will be initiated
 *                when addresses are requested that are not present in the internal
 *                buffer.
 *
 * \note In both cases the access to the flash device is terminated when there is no
 *       read request.
 *
 */
__STATIC_INLINE void hw_qspi_buf_lim(HW_QSPIC_ID id, bool enable) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_buf_lim(HW_QSPIC_ID id, bool enable)
{
        if (id == HW_QSPIC) {
                REG_SETF(QSPIC, QSPIC_CTRLMODE_REG, QSPIC_BUF_LIM_EN, enable);
        } else {
                ASSERT_WARNING(0);
        }
}
...
/**
 * \brief Write the NONCE value for the AES-CTR decryption
 *
 * The QSPI controller decrypts Flash contents on-the-fly using AES-CTR. AES-CTR uses a
 * 16-byte counter block (CTRB). The first 8 bytes of CTRB consist of the NONCE while the
 * other 8-bytes are produced automatically by the hardware.
 *
 * \param [in] id QSPI controller id
 * \param [in] nonce Pointer to the buffer containing the 8 NONCE bytes
 */
__RETAINED_CODE void hw_qspi_write_nonce(HW_QSPIC_ID id, const uint8_t *nonce);

/**
 * \brief Write the key for the AES-CTR decryption
 *
 * The QSPI controller decrypts Flash contents on-the-fly using AES-CTR. This function
 * is used to store the key to the QSPI controller.
 *
 * \param [in] id QSPI controller id
 * \param [in] key Pointer to the buffer containing the 32 key bytes
 */
__RETAINED_CODE void hw_qspi_write_key(HW_QSPIC_ID id, const uint8_t *key);

/**
 * \brief Set the address range for on-the-fly decryption
 *
 * The QSPI controller decrypts Flash contents on-the-fly using AES-CTR. This function is used
 * to define the address range in which the QSPI controller should decrypt the contents. The start
 * and end address of the range must be aligned to 1KByte (1024 bytes) blocks. This function will adjust
 * their values into the closest 1KByte, saddr is rounded down and eaddr is rounded up.
 * The address values must be absolute Flash addresses and not offsets within the QSPI address range of the bus.
 *
 * \param [in] id QSPI controller id
 * \param [in] saddr Start address of the decryption area in the Flash
 * \param [in] eaddr End address of the decryption area in the Flash
 */
__STATIC_INLINE void hw_qspi_set_decryption_address_range(HW_QSPIC_ID id, uint32_t saddr, uint32_t eaddr) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_set_decryption_address_range(HW_QSPIC_ID id, uint32_t saddr, uint32_t eaddr)
{
        if (id == HW_QSPIC) {
        /* End address must always be larger than start address */
                ASSERT_ERROR(eaddr > saddr);

                if (eaddr & 0x3FF) {
                        eaddr += 0x400;
                }
                QSPIC->QSPIC_CTR_SADDR_REG = saddr & 0xFFFFFC00;
                QSPIC->QSPIC_CTR_EADDR_REG = eaddr & 0xFFFFFC00;
        } else {
                ASSERT_WARNING(0);
        }
}
 ...
 *
 */
__STATIC_INLINE void hw_qspi_enable_decryption(HW_QSPIC_ID id)__attribute__((always_inline));

__STATIC_INLINE void hw_qspi_enable_decryption(HW_QSPIC_ID id)
{
        if (id == HW_QSPIC) {
                REG_SET_BIT(QSPIC, QSPIC_CTR_CTRL_REG, QSPIC_CTR_EN);
                __ISB();
        } else {
                ASSERT_WARNING(0);
        }
 ...
 *
 */
__STATIC_INLINE void hw_qspi_disable_decryption(HW_QSPIC_ID id)__attribute__((always_inline));

__STATIC_INLINE void hw_qspi_disable_decryption(HW_QSPIC_ID id)
{
       if (id == HW_QSPIC) {
                REG_CLR_BIT(QSPIC, QSPIC_CTR_CTRL_REG, QSPIC_CTR_EN);
                __ISB();
       } else {
                ASSERT_WARNING(0);
       }
 ...
 *
 */
__STATIC_INLINE void hw_qspi_force_nseq(HW_QSPIC_ID id, bool enable) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_force_nseq(HW_QSPIC_ID id, bool enable)
{
#if dg_configUSE_HW_QSPI2
        if (id == HW_QSPIC2) {
                REG_SETF(QSPIC2, QSPIC2_CTRLMODE_REG, QSPIC_FORCENSEQ_EN, enable);
        } else {
                ASSERT_WARNING(0);
        }
#endif
 ...
 *
 */
__STATIC_INLINE void hw_qspi_set_cs_mode(HW_QSPIC_ID id, HW_QSPI_CS_MODE edge) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_set_cs_mode(HW_QSPIC_ID id, HW_QSPI_CS_MODE edge)
{
        if (id == HW_QSPIC2) {
                REG_SETF(QSPIC2, QSPIC2_CTRLMODE_REG, QSPIC_CS_MD, edge);
        } else {
                ASSERT_WARNING(0);
        }
}
 ...
 *
 */
__STATIC_INLINE void hw_qspi_set_sram_mode(HW_QSPIC_ID id, bool enable) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_set_sram_mode(HW_QSPIC_ID id, bool enable)
{
        if (id == HW_QSPIC2) {
                REG_SETF(QSPIC2, QSPIC2_CTRLMODE_REG, QSPIC_SRAM_EN, enable);
        } else {
                ASSERT_WARNING(0);
        }
}
...
/**
 * \brief Enable the control of the maximum time tCEM (QSPIC2)
 *
 * \param [in] id QSPI controller id
 *
 */
__STATIC_INLINE void hw_qspi_enable_tCEM(HW_QSPIC_ID id) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_enable_tCEM(HW_QSPIC_ID id)
{
        if (id == HW_QSPIC2) {
                REG_SET_BIT(QSPIC2, QSPIC2_MEMBLEN_REG, QSPIC_T_CEM_EN);
        } else {
                ASSERT_WARNING(0);
        }
}
...
/**
 * \brief Set the maximum time tCEM (QSPIC2)
 *
 * \param [in] id QSPI controller id
 * \param [in] value The maximum allowed time tCEM for which QSPIC_CS can stay active (in us)
 *
 */
__STATIC_INLINE void hw_qspi_set_tCEM(HW_QSPIC_ID id, uint16_t value) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_set_tCEM(HW_QSPIC_ID id, uint16_t value)
{
        if (id == HW_QSPIC2) {
                REG_SETF(QSPIC2, QSPIC2_MEMBLEN_REG, QSPIC_T_CEM_CC, value);
        } else {
                ASSERT_WARNING(0);
        }
}
...
/**
 * \brief Set the length of a burst operation (QSPIC2)
 *
 * \param [in] id QSPI controller id
 ...
 *
 */
__STATIC_INLINE void hw_qspi_set_burst_length(HW_QSPIC_ID id, HW_QSPI2_MEMBLEN value) __attribute__((always_inline));

__STATIC_INLINE void hw_qspi_set_burst_length(HW_QSPIC_ID id, HW_QSPI2_MEMBLEN value)
{
        if (id == HW_QSPIC2) {
                REG_SETF(QSPIC2, QSPIC2_MEMBLEN_REG, QSPIC_MEMBLEN, value);
        } else {
                ASSERT_WARNING(0);
        }
}
