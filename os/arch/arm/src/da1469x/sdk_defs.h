...
/**
 * \brief Initialized external ram bss memory attributes
 */
#define __EXT_BSS               __attribute__((section("bss_ext_ram_init")))
        ...
        {                                                                                       \
                if (!(a)) {                                                                     \
                        if (dg_configIMAGE_SETUP == DEVELOPMENT_MODE) {                         \
                                ...
                                SYS_ASSERT_hook(__FILE__, __LINE__);                            \
                                do {} while (1);                                                \
                        }                                                                       \
                        else {                                                                  \
                                SYS_ASSERT_hook(__FILE__, __LINE__);                            \
...
#define ENABLE_CMAC_DEBUGGER \
        do { \
                REG_SET_BIT(CRG_TOP, SYS_CTRL_REG, CMAC_DEBUGGER_ENABLE); \
        } while (0)
