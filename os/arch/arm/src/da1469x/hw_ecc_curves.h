 ...
 */
__STATIC_INLINE void hw_ecc_p192_load_params(uint8_t *base_addr)
{
 ...
 * \param [in] base_addr The base address of the ECC engine data RAM (must be 1KiB aligned)
 */
__STATIC_INLINE void hw_ecc_p224_load_params(uint8_t *base_addr)
{
 ...
 * \param [in] base_addr The base address of the ECC engine data RAM (must be 1KiB aligned)
 */
__STATIC_INLINE void hw_ecc_p256_load_params(uint8_t *base_addr)
{
 ...
 * \param [in] base_addr The base address of the ECC engine data RAM (must be 1KiB aligned)
 */
__STATIC_INLINE void hw_ecc_b233_load_params(uint8_t *base_addr)
{
