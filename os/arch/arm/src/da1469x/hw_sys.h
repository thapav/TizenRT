 ...
 */
__STATIC_INLINE void hw_sys_track_reset_type(void) __attribute__((always_inline));

__STATIC_INLINE void hw_sys_track_reset_type(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_sys_enable_debugger(void) __attribute__((always_inline));

__STATIC_INLINE void hw_sys_enable_debugger(void)
{
        GLOBAL_INT_DISABLE();
 ...
 *
 */
__STATIC_INLINE void hw_sys_disable_debugger(void) __attribute__((always_inline));

__STATIC_INLINE void hw_sys_disable_debugger(void)
{
        GLOBAL_INT_DISABLE();
 ...
 *
 */
__STATIC_INLINE bool hw_sys_is_debugger_attached(void) __attribute__((always_inline));

__STATIC_INLINE bool hw_sys_is_debugger_attached(void)
{
