...
typedef enum {
        ...
        HW_UART_BAUDRATE_806400    = 0x00000209,
 ...
 * Callback function will be fired with data already present in buffer.
...
{
        if (uart == HW_UART3)
                return REG_GETF(UART3, UART3_CONFIG_REG, ISO7816_SCRATCH_PAD);
