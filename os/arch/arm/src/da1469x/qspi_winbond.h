 ...
 */
        ...
        const uint32_t w25q_ucode_wakeup[] = {
                0x09000001 | (((uint16_t)(W25Q_POWER_UP_DELAY_US*1000/31.25) & 0xFFFF) << 8),
                0x00FF0000,
        };
 ...
 */
         ...
         */
        const uint32_t w25q_ucode_wakeup[] = {
                0xAB000009 | (((uint16_t)(W25Q_RELEASE_POWER_DOWN_DELAY_US*1000/31.25) & 0xFFFF) << 8),
        };
#else
/**
 ...
 */
__STATIC_INLINE void flash_w25q_wre_volatile(HW_QSPIC_ID id) __attribute__((always_inline)) __UNUSED;
__STATIC_INLINE void flash_w25q_wre_volatile(HW_QSPIC_ID id)
{
...
__STATIC_INLINE uint8_t flash_w25q_read_status_register_2(HW_QSPIC_ID id) __attribute__((always_inline));
__STATIC_INLINE uint8_t flash_w25q_read_status_register_2(HW_QSPIC_ID id)
{
 ...
 */
__STATIC_INLINE void flash_w25q_write_status_register_2(HW_QSPIC_ID id, uint8_t value) __attribute__((always_inline));
__STATIC_INLINE void flash_w25q_write_status_register_2(HW_QSPIC_ID id, uint8_t value)
{
...
__STATIC_INLINE void flash_w25q_enable_quad_mode(HW_QSPIC_ID id) __attribute__((always_inline));
__STATIC_INLINE void flash_w25q_enable_quad_mode(HW_QSPIC_ID id)
{
        uint8_t status;
...
__RETAINED_CODE static void flash_w25q_initialize(HW_QSPIC_ID id)
{
