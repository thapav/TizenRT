 ...
 *
 */
__STATIC_INLINE void hw_timer2_set_division_factor(HW_TIMER2_DIV div_factor)
{
        GLOBAL_INT_DISABLE();
 ...
 *
 */
__STATIC_INLINE void hw_timer2_set_clk(HW_TIMER2_CLK_SRC clk)
{
 ...
 *
 */
__STATIC_INLINE HW_TIMER2_DIV hw_timer2_get_division_factor(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer2_enable(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer2_disable(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer2_set_frequency(uint16_t frequency)
{
 ...
 *
 */
__STATIC_INLINE uint16_t hw_timer2_get_frequency(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer2_set_hw_pause(bool enable)
{
 ...
 */
__STATIC_INLINE bool hw_timer2_get_hw_pause(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer2_set_sw_pause(bool enable)
{
 ...
 *
 */
__STATIC_INLINE bool hw_timer2_get_sw_pause(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer2_freeze(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer2_unfreeze(void)
{
