...
/**
 * \brief Callback called on DMA operation completed
 *
 * \param [in] id I2C controller instance
 ...
 *
 */
__STATIC_INLINE void hw_i2c_disable(HW_I2C_ID id)
{
 ...
 *
 */
__STATIC_INLINE uint16_t hw_i2c_get_abort_source(HW_I2C_ID id)
{
