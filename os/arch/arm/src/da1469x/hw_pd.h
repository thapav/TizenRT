 ...
 *
 */
__STATIC_INLINE void hw_pd_power_up_periph(void) __attribute__((always_inline));

__STATIC_INLINE void hw_pd_power_up_periph(void)
{
        GLOBAL_INT_DISABLE();
 ...
 */
__STATIC_INLINE void hw_pd_power_down_periph(void) __attribute__((always_inline));

__STATIC_INLINE void hw_pd_power_down_periph(void)
{
        GLOBAL_INT_DISABLE();
 ...
 */
__STATIC_INLINE void hw_pd_wait_power_down_periph(void) __attribute__((always_inline));

__STATIC_INLINE void hw_pd_wait_power_down_periph(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_pd_power_up_rad(void) __attribute__((always_inline));

__STATIC_INLINE void hw_pd_power_up_rad(void)
{
        GLOBAL_INT_DISABLE();
 ...
 * The PD will not be powered down if there is a pending PDC entry for this PD.
 */
__STATIC_INLINE void hw_pd_wait_power_down_rad(void) __attribute__((always_inline));

__STATIC_INLINE void hw_pd_wait_power_down_rad(void)
{
 ...
 * the system enters sleep state.
 */
__STATIC_INLINE void hw_pd_power_up_com(void) __attribute__((always_inline));

__STATIC_INLINE void hw_pd_power_up_com(void)
{
        GLOBAL_INT_DISABLE();
 ...
 *
 */
__STATIC_INLINE void hw_pd_power_down_com(void) __attribute__((always_inline));

__STATIC_INLINE void hw_pd_power_down_com(void)
{
        GLOBAL_INT_DISABLE();
 ...
 * The PD will not be powered down if there is a pending PDC entry for this PD.
 */
__STATIC_INLINE void hw_pd_wait_power_down_com(void) __attribute__((always_inline));

__STATIC_INLINE void hw_pd_wait_power_down_com(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_pd_power_up_tim(void) __attribute__((always_inline));

__STATIC_INLINE void hw_pd_power_up_tim(void)
{
        GLOBAL_INT_DISABLE();
 ...
 * the system enters sleep state.
 */
__STATIC_INLINE void hw_pd_power_down_tim(void) __attribute__((always_inline));

__STATIC_INLINE void hw_pd_power_down_tim(void)
{
        GLOBAL_INT_DISABLE();
 ...
 * The PD will not be powered down if there is a pending PDC entry for this PD.
 */
__STATIC_INLINE void hw_pd_wait_power_down_tim(void) __attribute__((always_inline));

__STATIC_INLINE void hw_pd_wait_power_down_tim(void)
{
