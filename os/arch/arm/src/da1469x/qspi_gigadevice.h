...
__STATIC_INLINE uint8_t flash_gd_read_status_register_1(HW_QSPIC_ID id) __attribute__((always_inline)) __UNUSED;
__STATIC_INLINE uint8_t flash_gd_read_status_register_1(HW_QSPIC_ID id)
{
...
__STATIC_INLINE void flash_gd_write_status_register(HW_QSPIC_ID id, uint16_t value) __attribute__((always_inline)) __UNUSED;
__STATIC_INLINE void flash_gd_write_status_register(HW_QSPIC_ID id, uint16_t value)
{
...
__STATIC_INLINE void flash_gd_enable_quad_mode(HW_QSPIC_ID id) __attribute__((always_inline));
__STATIC_INLINE void flash_gd_enable_quad_mode(HW_QSPIC_ID id)
{
        uint16_t status;
