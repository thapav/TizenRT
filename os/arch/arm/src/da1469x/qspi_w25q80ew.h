 ...
 ****************************************************************************************
 */
#ifndef _QSPI_W25Q80EW_H_
#define _QSPI_W25Q80EW_H_
...
static void flash_w25q80ew_sys_clock_cfg(HW_QSPIC_ID id, sys_clk_t sys_clk);
static uint8_t flash_w25q80ew_get_dummy_bytes(HW_QSPIC_ID id);
...
__RETAINED_CODE static void flash_w25q80ew_sys_clock_cfg(HW_QSPIC_ID id, sys_clk_t sys_clk)
{

}

__RETAINED_CODE static uint8_t flash_w25q80ew_get_dummy_bytes(HW_QSPIC_ID id)
{
        return 2;
}

#endif /* _QSPI_W25Q80EW_H_ */
/**
 * \}
 * \}
 */
