 ...
 *
 */
__STATIC_INLINE void hw_irgen_clear_interrupt(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_irgen_set_carrier_freq(uint16_t hi_time, uint16_t lo_time)
{
 ...
 */
__STATIC_INLINE void hw_irgen_set_logic0_param(HW_IRGEN_LOGIC_FORMAT format, uint8_t mark_time,
                                                                                uint8_t space_time)
{
 ...
 * \sa hw_ir_insert_digital_message
 */
__STATIC_INLINE void hw_irgen_set_logic1_param(HW_IRGEN_LOGIC_FORMAT format, uint8_t mark_time,
                                                                                uint8_t space_time)
{
 ...
 *
 */
__STATIC_INLINE void hw_irgen_set_repeat_fifo(HW_IRGEN_FIFO fifo)
{
 ...
 *
 */
__STATIC_INLINE void hw_irgen_set_repeat_time(uint16_t time)
{
 ...
 *
 */
__STATIC_INLINE void hw_irgen_insert_digital_message(HW_IRGEN_FIFO fifo, uint8_t length,
                                                                                uint16_t payload)
{
 ...
 *
 */
__STATIC_INLINE void hw_irgen_insert_paint_message(HW_IRGEN_FIFO fifo, HW_IRGEN_PAINT symbol,
                                                                                uint16_t duration)
{
 ...
 *
 */
__STATIC_INLINE void hw_irgen_flush_fifo(HW_IRGEN_FIFO fifo)
{
        if (fifo == HW_IRGEN_FIFO_REPEAT) {
 ...
 *
 */
__STATIC_INLINE void hw_irgen_set_output_type(HW_IRGEN_OUTPUT output)
{
 ...
 *
 */
__STATIC_INLINE void hw_irgen_start(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_irgen_stop(void)
{
 ...
 *
 */
__STATIC_INLINE bool hw_irgen_is_busy(void)
{
 ...
 *
 */
__STATIC_INLINE uint16_t hw_irgen_get_fifo_level(HW_IRGEN_FIFO fifo)
{
        if (fifo == HW_IRGEN_FIFO_REPEAT) {
 ...
 *
 */
__STATIC_INLINE uint16_t hw_irgen_reverse_bit_order(uint16_t val, uint8_t bits)
{
        uint16_t ret = 0;
