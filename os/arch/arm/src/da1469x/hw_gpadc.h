...
typedef enum {
        ...
        HW_GPADC_INPUT_SE_VDD_HIGH = 4,
        HW_GPADC_INPUT_SE_V33_1 = 5,
        HW_GPADC_INPUT_SE_V33_2 = 6,
        HW_GPADC_INPUT_SE_VDCDC = 7,
        HW_GPADC_INPUT_SE_VBAT = 8,
        HW_GPADC_INPUT_SE_VSSA = 9,
 ...
 */
typedef enum {
        HW_GPADC_NO_TEMP_SENSOR              = 0,    /**< No on-chip temperature sensor selected (default) */
        HW_GPADC_TEMP_SENSOR_NEAR_RADIO      = 1,    /**< Temperature sensor near radio */
        HW_GPADC_TEMP_SENSOR_NEAR_CHARGER    = 2,    /**< Temperature sensor near charger */
        HW_GPADC_TEMP_SENSOR_NEAR_BANDGAP    = 3,    /**< Temperature sensor near bandgap */
 ...
 *
 * Once enabled, then the temperature sensor can be selected
 *
...
{
        REG_SETF(GPADC, GP_ADC_CTRL_REG, GP_ADC_DIFF_TEMP_SEL, sensor);
}
 ...
 *
 * The received digital value of GPADC is converted to temperature value of degrees Celsius.
 *
