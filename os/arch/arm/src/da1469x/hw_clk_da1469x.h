 ...
 */
#define XTALRDY_CYCLES_TO_LP_CLK_CYCLES(x, lp_freq) ((x * lp_freq * 125 + dg_configRC32M_FREQ_MIN/2) / dg_configRC32M_FREQ_MIN)
 ...
 */
__STATIC_INLINE void hw_clk_disable_rc32(void) __attribute__((always_inline));

__STATIC_INLINE void hw_clk_disable_rc32(void)
{
 ...
 */
__STATIC_INLINE void hw_clk_set_xtalm_settling_time(uint8_t cycles, bool high_clock) __attribute__((always_inline));

__STATIC_INLINE void hw_clk_set_xtalm_settling_time(uint8_t cycles, bool high_clock)
{
 ...
 */
__STATIC_INLINE uint16_t hw_clk_get_xtalm_settling_time(void) __attribute__((always_inline));

__STATIC_INLINE uint16_t hw_clk_get_xtalm_settling_time(void)
{
        uint32_t val = CRG_XTAL->XTALRDY_CTRL_REG;
 ...
 */
__STATIC_INLINE sys_clk_is_t hw_clk_get_sysclk(void) __attribute__((always_inline));

__STATIC_INLINE sys_clk_is_t hw_clk_get_sysclk(void)
{
...
{
        uint32_t reg = CRG_TOP->CLK_RCX_REG;

        REG_SET_FIELD(CRG_TOP, CLK_RCX_REG, RCX_BIAS, reg, 0xA);
        REG_SET_FIELD(CRG_TOP, CLK_RCX_REG, RCX_C0, reg, 0xA);
        REG_SET_FIELD(CRG_TOP, CLK_RCX_REG, RCX_CADJUST, reg, 0xA);
        REG_SET_FIELD(CRG_TOP, CLK_RCX_REG, RCX_RADJUST, reg, 0xA);

        CRG_TOP->CLK_RCX_REG = reg;
}
 ...
 */
__STATIC_INLINE void hw_clk_pll_sys_on(void) __attribute__((always_inline));

__STATIC_INLINE void hw_clk_pll_sys_on(void)
{
	int32_t retry = 100;
        ...
        } while (!REG_GETF(CRG_XTAL, XTAL32M_CTRL0_REG, XTAL32M_DXTAL_SYSPLL_ENABLE) && retry-- > 0);
 ...
 */
__STATIC_INLINE void hw_clk_pll_sys_off(void) __attribute__((always_inline));

__STATIC_INLINE void hw_clk_pll_sys_off(void)
{
        GLOBAL_INT_DISABLE();
...
/**
 * \brief Perform XTAL32M frequency temperature compensation.
 */
