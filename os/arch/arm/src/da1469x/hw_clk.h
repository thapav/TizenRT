 ...
 */
__STATIC_INLINE ahb_div_t hw_clk_get_hclk_div(void) __attribute__((always_inline));

__STATIC_INLINE ahb_div_t hw_clk_get_hclk_div(void)
{
 ...
 */
__STATIC_INLINE apb_div_t hw_clk_get_pclk_div(void) __attribute__((always_inline));

__STATIC_INLINE apb_div_t hw_clk_get_pclk_div(void)
{
 ...
 */
__STATIC_INLINE void hw_clk_set_hclk_div(ahb_div_t div) __attribute__((always_inline));

__STATIC_INLINE void hw_clk_set_hclk_div(ahb_div_t div)
{
 ...
 */
__STATIC_INLINE void hw_clk_set_pclk_div(apb_div_t div) __attribute__((always_inline));

__STATIC_INLINE void hw_clk_set_pclk_div(apb_div_t div)
{
