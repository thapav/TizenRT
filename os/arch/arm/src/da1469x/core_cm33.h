...
#include "sdk_defs.h" /* Declares IRQn_Type */
  ...
  #define NVIC_SetPriority            __NVIC_SetPriority /*!< Sets the priority of a device specific interrupt or a processor exception. */
  #define NVIC_GetPriority            __NVIC_GetPriority /*!< Reads the priority of a device specific interrupt or a processor exception. */
