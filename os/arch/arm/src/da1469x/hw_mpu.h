 ...
 *
 */
__STATIC_INLINE void hw_mpu_enable(bool privdefena) __attribute__((always_inline));

__STATIC_INLINE void hw_mpu_enable(bool privdefena)
{
 ...
 *
 */
__STATIC_INLINE void hw_mpu_disable(void) __attribute__((always_inline));

__STATIC_INLINE void hw_mpu_disable(void)
{
        __DMB();
...
*/
__STATIC_INLINE void hw_mpu_config_region(HW_MPU_REGION_NUM region_num,
                                        mpu_region_config *cfg) __attribute__((always_inline));

__STATIC_INLINE void hw_mpu_config_region(HW_MPU_REGION_NUM region_num, mpu_region_config *cfg)
{
        if (!cfg) {
                MPU->RNR = region_num;
                MPU->RBAR = 0x0;
