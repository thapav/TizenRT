 ...
 *
 */
__STATIC_INLINE void hw_timer0_enable(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer0_disable(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer0_set_clock_source(HW_TIMER0_CLK_SRC clk_src)
{
 ...
 *
 */
__STATIC_INLINE HW_TIMER0_CLK_SRC hw_timer0_get_clock_source(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer0_set_fast_clock_div(HW_TIMER0_FAST_CLK_DIV div)
{
        GLOBAL_INT_DISABLE();
 ...
 *
 */
__STATIC_INLINE HW_TIMER0_FAST_CLK_DIV  hw_timer0_get_fast_clock_div(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer0_set_on_clock_div(bool enabled)
{
 ...
 *
 */
__STATIC_INLINE bool hw_timer0_get_on_clock_div(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer0_set_pwm_mode(HW_TIMER0_MODE mode)
{
 ...
 *
 */
__STATIC_INLINE HW_TIMER0_MODE hw_timer0_get_pwm_mode(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer0_set_t0_reload(uint16_t m_value, uint16_t n_value)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer0_set_on_reload(uint16_t value)
{
 ...
 *
 */
__STATIC_INLINE uint16_t hw_timer0_get_t0(void)
{
 ...
 *
 */
__STATIC_INLINE uint16_t hw_timer0_get_on(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer0_freeze(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_timer0_unfreeze(void)
{
