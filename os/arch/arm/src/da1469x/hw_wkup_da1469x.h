...
/**
 * \brief Separated each of Unregister interrupt handler
 *
 * Interrupt is automatically disabled after calling this function.
 *
 */
void hw_wkup_unregister_key_interrupt(void);
void hw_wkup_unregister_p0_interrupt(void);
void hw_wkup_unregister_p1_interrupt(void);
