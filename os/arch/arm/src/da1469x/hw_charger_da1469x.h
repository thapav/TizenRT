...
#ifndef HW_CHARGER_D2522_H_
#define HW_CHARGER_D2522_H_
 ...
 */
typedef enum {
        HW_CHARGER_I_EOC_PERCENT_LEVEL_6 = 0,   /**<   6% */
        HW_CHARGER_I_EOC_PERCENT_LEVEL_8,       /**<   8% */
        HW_CHARGER_I_EOC_PERCENT_LEVEL_10,      /**<  10% */
        HW_CHARGER_I_EOC_PERCENT_LEVEL_12,      /**<  12% */
        HW_CHARGER_I_EOC_PERCENT_LEVEL_14,      /**<  14% */
        HW_CHARGER_I_EOC_PERCENT_LEVEL_16,      /**<  16% */
        HW_CHARGER_I_EOC_PERCENT_LEVEL_18,      /**<  18% */
        HW_CHARGER_I_EOC_PERCENT_LEVEL_20,      /**<  20% */
        HW_CHARGER_I_EOC_PERCENT_LEVEL_24,      /**<  24% */
        HW_CHARGER_I_EOC_PERCENT_LEVEL_28,      /**<  28% */
        HW_CHARGER_I_EOC_PERCENT_LEVEL_32,      /**<  32% */
        HW_CHARGER_I_EOC_PERCENT_LEVEL_36,      /**<  36% */
        HW_CHARGER_I_EOC_PERCENT_LEVEL_40       /**<  40% */
...
{
        if (eoc_i_thr > HW_CHARGER_I_EOC_PERCENT_LEVEL_20) {
                ...
                REG_SETF(CHARGER, CHARGER_CURRENT_PARAM_REG, I_END_OF_CHARGE,
                         eoc_i_thr - HW_CHARGER_I_EOC_PERCENT_LEVEL_16);
        } else {
...
__STATIC_INLINE HW_CHARGER_I_EOC_PERCENT_LEVEL hw_charger_get_eoc_current_threshold(void)
{
        if (REG_GETF(CHARGER, CHARGER_CURRENT_PARAM_REG, I_EOC_DOUBLE_RANGE)) {
                return (REG_GETF(CHARGER, CHARGER_CURRENT_PARAM_REG, I_END_OF_CHARGE) +
                        HW_CHARGER_I_EOC_PERCENT_LEVEL_16);
        } else {
                return REG_GETF(CHARGER, CHARGER_CURRENT_PARAM_REG, I_END_OF_CHARGE);
        }
}
