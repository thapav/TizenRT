 ...
 *
 */
__STATIC_INLINE void hw_watchdog_set_pos_val(uint16_t value) __attribute__((always_inline));

__STATIC_INLINE void hw_watchdog_set_pos_val(uint16_t value)
{
        uint32_t tmp;
 ...
 *
 */
__STATIC_INLINE void hw_watchdog_gen_RST(void) __attribute__((always_inline));

__STATIC_INLINE void hw_watchdog_gen_RST(void)
{
 ...
 *
 */
__STATIC_INLINE void hw_watchdog_gen_NMI(void) __attribute__((always_inline));

__STATIC_INLINE void hw_watchdog_gen_NMI(void)
{
